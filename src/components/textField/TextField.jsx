  ...
  return (
    <>
      <div className="relative mx-4 mt-4">
        <input
          id={id}
          className={`block rounded-md py-3 px-2 text-sm text-gray-900 bg-transparent border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-yellow-400 focus:outline-none focus:ring-yellow-400 focus:border-yellow-400 peer ${
